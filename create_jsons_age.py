...
BASE_DIR = "data_cslu"
OUTPUT_DIR = os.path.join("data_cslu_splits", "all")
...
for cslu_option in ["scripted", "spontaneous"]:
    ...
    if cslu_option == "scripted":
        ###make a custom train,dev,test split with no speaker overlap and equal grade distribution
